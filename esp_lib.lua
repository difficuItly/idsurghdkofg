...
-- grabbing utils
local UtilsString = loadstring(game:HttpGet('https://raw.githubusercontent.com/difficuItly/idsurghdkofg/main/ray%20casting'))()
spawn(function() Utils = UtilsString end)
